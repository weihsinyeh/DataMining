...
with open('./Dataset/graph_3_1.txt') as f:
    lines = f.readlines()
...
#nx.draw(G, with_labels=True, node_size=20, edge_color='#eb4034', width=1, font_size=2, font_weight=2, arrowsize=2, alpha=0.8)
nx.draw(G, with_labels=True, node_size=2000, edge_color='#eb4034', width=3, font_size=16, font_weight=500, arrowsize=20, alpha=0.8)
plt.savefig("graph_1_1.png")