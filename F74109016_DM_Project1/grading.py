...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_path', type=str, default='./outputs/ibm-2023-released-fp_growth-0.05-0.05.csv')
    parser.add_argument('--reference_path', type=str, default='./outputs/ibm-2023-released-apriori-0.05-0.05.csv')
